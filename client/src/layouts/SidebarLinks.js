...
import { checkPath, useEffectOnce } from "../utils/utils"
...
const SidebarLinks = ({ currentTab }) => {
    ...
    return (
        <div className='mt-2'>
            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-gray-800 bg-green-800 bg-opacity-25 rounded-full mt-1 mb-2 align-middle ml-2 text-sm px-4 py-2 text-center inline-flex w-6/6 justify-between items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                <img class="w-8 h-8 inline-block rounded-full border-2 border-white dark:border-gray-800" src={profile1} alt="" />
                <div className='px-2'>
                    <h4 className='font-medium'>{auth?.username}</h4>
                    <h4 className='text-left text-xs text-gray-200 font-normal'>{auth?.role}</h4>
                </div>
            ...
            <a href='/admin/overview' className={`font-medium transform ${currentTab === "overview" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm ${checkPath("/admin/employees") ? "bg-white text-blue-600 border-r-4 border-l-8 border-blue-600" : ""} `} >
            ...
            <a href='/admin/foods' className={`${auth?.role==="ROLE_CTR_USER"?"hidden":""} font-medium transform ${currentTab === "crops" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `} >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <span className='text-left text-xs  pl-5'>Food</span>
            </a>
            <a href='/admin/process' className={`${auth?.role==="ROLE_CTR_USER"?"hidden":""} font-medium transform ${currentTab === "activities" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                </svg>
                <span className='text-left text-xs pl-5'>Processes</span>
            </a>
            <a href='/admin/stage' className={`${auth?.role==="ROLE_CTR_USER"?"hidden":""} font-medium transform ${currentTab === "stages" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `} >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                </svg>
            ...
            <a href='/admin/users' className={`${auth?.role!=="ROLE_SYS_ADMIN"?"hidden":""} font-medium transform ${currentTab === "users" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span className='text-left text-xs pl-5'>Users</span>
            </a>
            <a href='/admin/countries' className={`${auth?.role==="ROLE_CTR_USER"?"hidden":""} font-medium transform ${currentTab === "countries" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                </svg>
            ...
            <a href='/admin/analytics' className={`font-medium transform ${currentTab === "analytics" ? "bg-white text-blue-600 border-r-4 border-green-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
