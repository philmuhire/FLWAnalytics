        ...
        <div className='mt-2'>
            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-gray-800 bg-green-800 bg-opacity-25 rounded-full mt-1 mb-2 align-middle ml-2 text-sm px-4 py-2 text-center inline-flex w-5/6 justify-between items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                ...
                <div>
                    ...
                    <h4 className='text-left text-xs text-gray-200 font-normal'>admin</h4>
                </div>
            ...
            <a href='/admin/stage' className={`font-medium transform ${currentTab === "stages" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `} >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                </svg>
            ...
            <a href='/admin/users' className={`font-medium transform ${currentTab === "users" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span className='text-left text-xs pl-5'>Users</span>
            </a>
            <a href='/admin/countries' className={`font-medium transform ${currentTab === "countries" ? "bg-white text-blue-600 border-r-4 border-blue-600" : ""} focus:bg-white focus:text-blue-600 hover:bg-white hover:text-blue-500 hover:translate-x-2 transition-transform ease-in duration-200 text-gray-200 cursor-pointer flex justify-start items-center pl-5 py-2.5 rounde-sm `}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                    <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                </svg>
