...
import { fetchCountries, getCountryError, getCountryStatus, selectAllCountries } from '../../../services/reducers/countrySlice';
...
const Country = () => {
    ...
    const status = useSelector(getCountryStatus);
            ...
            <div className='flex flex-grow flex-col justify-start px-7 py-4 h-screen overflow-y-scroll '>
                ...
                <div className='mx-2 my-2 '>
                    <div className='flex justify-between'>
                        <h3 className='font-bold text-sm'>Countries Overview</h3>
                        ...
                        <tbody>
                            {
                                ...
                                (
                                    <tr className="coborder-t-2  border-gray-300 text-sm text-gray-700">
                                        <td className="py-1">
                                            <span className='pl-3'>{country.name}</span>
                                        </td>
                                        <td>{country.region?country.region:"N/A"}</td>
